...
func main() {
	...
	app2URL := makeApp2Url(app2Host, port2)
	fmt.Println(app2URL)

	http.HandleFunc("/hello", func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte("Hello from Test App 1"))
	})

	http.HandleFunc("/hello-from-app2", func(w http.ResponseWriter, r *http.Request) {
...
func makeApp2Url(app2Host string, port2 string) string {
